...
public class PreferencesUtil {
    ...
    public String getToken(){
        return preferences.getString(ShareConstants.KEY_TOKEN,"");
    }

    public String getUserName(){
        return getParam(ShareConstants.KEY_USER_NAME,"").toString();
    }
    public String  getUserId(){
        return (String) getParam(ShareConstants.KEY_USER_ID,"");
    }

    public String  getUserCard(){
        return (String) getParam(ShareConstants.KEY_CARD_NAME,"");
    }

    public void   setCardTime(String time){
        saveParam(ShareConstants.KEY_CARD_TIME,time);
    }

    public String  getCardTime(){
        return getParam(ShareConstants.KEY_CARD_TIME,"").toString();
    }

    public void clearData(){
        saveParam(ShareConstants.KEY_TOKEN,"");
        saveParam(ShareConstants.KEY_USER_ID,"");
        saveParam(ShareConstants.KEY_USER_NAME,"");
        saveParam(ShareConstants.KEY_INVITE_CODE,"");

    }


    public boolean getIsExpire(){
        return preferences.getBoolean(ShareConstants.KEY_IS_EXPIRE,false);
    }
